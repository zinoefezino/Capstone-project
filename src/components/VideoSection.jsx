      ...
      <div className="container">
        <div className="video-text">
          ...
          <p>
            ...
            <span style={{ color: "#164BAF" }}>mass, diameter, gravity, </span>{" "}
            and <span style={{ color: "#164BAF" }}>density,</span> we gain
        ...
        <div className="video-wrapper">
          ...
          >
            <source
              src="https://assets.mixkit.co/videos/45015/45015-720.mp4"
              type="video/mp4"
            />
